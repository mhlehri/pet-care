<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $upload_photo = "upload/bird_item/" . $uniqe_Name;
        ...
        if(empty($product_name) || empty($product_d_price) || empty($product_delivery) || empty($product_des) || empty($photo_name)){
            ...
            $sql = "insert into b_product_d (name, price, a_price, tag, d_method, p_des, p_img) values ('$product_name', '$product_d_price', '$product_a_price' , '$product_tag', '$product_delivery', '$product_des', '$upload_photo')";
           ...
           if($result){
            echo "<script>
                ...
                window.location.href= 'manage_product.php#contact-tab';
            </script>";
...
<div class="col-md-9">
    ...
    <div class="contain_edit">
        <h4 class='text-center'>Add Bird Items</h4>
        <form action="add_bird_product.php" method="post" enctype="multipart/form-data">
