<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(empty($product_name) || empty($product_d_price) || empty($product_delivery) || empty($product_des) || empty($photo_name)){
            ...
            $sql = "insert into c_product_d (name, price, a_price, tag, d_method, p_des, p_img) values ('$product_name', '$product_d_price', '$product_a_price' , '$product_tag', '$product_delivery', '$product_des', '$upload_photo')";
...
<div class="col-md-9">
    ...
    <div class="contain_edit">
        <h4 class='text-center'>Add Cat Items</h4>
        <form action="add_cat_product.php" method="post" enctype="multipart/form-data">
